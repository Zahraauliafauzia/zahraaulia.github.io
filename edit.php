...
<?php
   ...
   if(isset($_GET['nim'])) {
       ...
       $strSQL = "SELECT * FROM mahasiswa WHERE nim='$nim'";    //SELECT nim,namadepan,namabelakang,email FROM mahasiswa
       $execStrSQL = mysqli_query($conn,$strSQL);
...
?>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">        
        <table class="table table-striped">
            ...
            <tr>
                <th>NIM</th>
                <th><input type="text" class="form-control" name="nim" value="<?= $nim ?>"
                     readonly ></th>       
            </tr>
            </thead>
            <tbody>
